...
#define OPTION_INDEX_LED_OFF_DEFAULT 0x8B    //ver 1.5
...
#elif HAS_ROW_18
    #define OPTION_GET_REPORT_LENGTH_KEYMAP         144
    #define OPTION_GET_REPORT_LENGTH_KEYMAP_LAYER1  145
    #define OPTION_GET_REPORT_LENGTH_KEYMAP_LAYER2  146
    #define OPTION_GET_REPORT_LENGTH_KEYMAP_LAYER3  147
    #define OPTION_GET_REPORT_LENGTH_KEYMAP_LAYER4  148
#else
...
#define OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA1  192
enum{
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA2 = 193,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA3,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA4,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA5,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA6,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA7,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA8,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA9,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA10,
    OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA11,     // 202
};
#define OPTION_GET_REPORT_LENGTH_QUICK_MACRO_EXTRA12  203
