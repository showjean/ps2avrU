...
/*KEY_HANJA,	KEY_HANGLE,	KEY_POWER,	KEY_SLEEP,	KEY_WAKE,	KEY_EMAIL, KEY_WWW_SEARCH, KEY_WWW_HOME, KEY_WWW_BACK, KEY_WWW_FORWARD,	
...
const uint8_t PROGMEM keymap_code[3][17][8] =  {
	{
		...
		{ KEY_HANJA,		KEY_MUTE,	KEY_VOL_UP,		KEY_ESC,	KEY_MEDIA,		KEY_NONE,	KEY_HASH,	KEY_1 },	// ROW1
		{ KEY_HANGLE,		KEY_CAPS,	KEY_VOL_DOWN,		KEY_NONE,	KEY_CALC,		KEY_NONE,	KEY_F1, 	KEY_2 },	// ROW2
		{ KEY_POWER,		KEY_F3, 	KEY_WWW_STOP,		KEY_F4, 	KEY_MYCOM,		KEY_NONE,	KEY_F2, 	KEY_3 },	// ROW3
		{ KEY_SLEEP,		KEY_WAKE,		KEY_WWW_REFRESH,		KEY_WWW_FAVORITE,		KEY_SCREENSAVE,		KEY_REC,		KEY_5,		KEY_4 },	// ROW4
		{ KEY_WWW_SEARCH,		KEY_EMAIL,		KEY_PREV_TRK,		KEY_NEXT_TRK,		KEY_MINIMIZE,		KEY_REWIND,		KEY_6,		KEY_7 },	// ROW5
		{ KEY_WWW_HOME,		KEY_RBR,	KEY_STOP,		KEY_F6, 	KEY_EJECT,	KEY_NONE,	KEY_EQUAL,	KEY_8 },	// ROW6
		{ KEY_WWW_BACK,		KEY_F7, 	KEY_PLAY,		KEY_NONE,		KEY_DOT,	KEY_FN,		KEY_F8, 	KEY_9 },	// ROW7
		{ KEY_WWW_FORWARD,		KEY_LBR,	KEY_COLON,	KEY_QUOTE,	KEY_NONE,	KEY_SLASH,	KEY_MINUS,	KEY_0}, 	// ROW8
